...
/**     
* @Package：cn.ucaner.oneday.common.utils   
* @ClassName：LunarUtils   
* @Description：   <p> LunarUtils - 勿忘初心 方得始终 </p>
* @Author： - Jason    
* @CreatTime：2019年1月3日 下午4:52:19   
* @Modify By：   
...
public class LunarUtils {
    ...
    /**
    * LunarUtils. 
    * 			cal 传出y年m月d日对应的农历. yearCyl3:农历年与1864的相差数 ? monCyl4:从1900年1月31日以来,闰月数
    ...
    * @param cal
    ...
    /**
     * @Description: getLunarDayStr
     * @return String
     * @Autor: @Jason - jasonandy@hotmail.com
     */
    public static String getLunarDayStr() {
    	Date date = new Date();  
	...
	public static void main(String[] args) throws ParseException {  
	    System.out.println(getLunarDayStr());
	}  
