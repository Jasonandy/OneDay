...
import cn.ucaner.oneday.jfoenix.model.DemoInfo;
import cn.ucaner.oneday.jfoenix.model.DemoInfoCache;
import cn.ucaner.oneday.jfoenix.util.HttpResponse;
import cn.ucaner.oneday.jfoenix.util.HttpsClient;
import cn.ucaner.oneday.jfoenix.util.NotificationUtils;
...
public class DemoController {
    ...
    private void initSpinner() {
        ...
        scene.getStylesheets().add(DemoController.class
            .getResource("/jfx/css/register-dialog.css").toExternalForm());
